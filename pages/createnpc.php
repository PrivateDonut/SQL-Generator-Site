...
<div class="inputcontent">
    <div class="form-group">
      Goosip <input type="checkbox" name="checkbox_value[]" value=1>
      Quest Giver <input type="checkbox" name="checkbox_value[]" value=2>
      Trainer <input type="checkbox" name="checkbox_value[]" value=16>
      Class Trainer <input type="checkbox" name="checkbox_value[]" value=32>
      Profession Trainer <input type="checkbox" name="checkbox_value[]" value=64>
      Vendor <input type="checkbox" name="checkbox_value[]" value=128>
      Repair Vendor <input type="checkbox" name="checkbox_value[]" value=4096>
      Inn Keeper <input type="checkbox" name="checkbox_value[]" value=128>
      Banker <input type="checkbox" name="checkbox_value[]" value=131072>
  </div>
</div>
