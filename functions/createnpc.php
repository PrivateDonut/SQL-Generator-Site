...
if (empty($_POST['modelid1'])) {
    $modelid1 = 0;
} else {
    $modelid1 = $_POST['modelid1'];
}
if (empty($_POST['modelid2'])) {
    $modelid2 = 0;
} else {
    $modelid2 = $_POST['modelid2'];
}
if (empty($_POST['modelid3'])) {
    $modelid3 = 0;
} else {
    $modelid3 = $_POST['modelid3'];
}
if (empty($_POST['modelid4'])) {
    $modelid4 = 0;
} else {
    $modelid4 = $_POST['modelid4'];
}
if (empty($_POST['cName'])) {
    $cName = "Name Placement Here";
} else {
    $cName = $_POST['cName'];
}
if (empty($_POST['cSubname'])) {
    $cSubname = "Name Sub Placement Here";
} else {
    $cSubname = $_POST['cSubname'];
}
if (empty($_POST['minlevel'])) {
    $minlevel = 1;
} else {
...
if (empty($_POST['speed_walk'])) {
    $speed_walk = 0;
} else {
    $speed_walk = $_POST['speed_walk'];
}
if (empty($_POST['speed_run'])) {
    $speed_run = 0;
} else {
    $speed_run = $_POST['speed_run'];
}
...
if (empty($_POST['dmgschool'])) {
    $dmgschool = 0;
} else {
    $dmgschool = $_POST['dmgschool'];
}
if (empty($_POST['BaseAttackTime'])) {
    $BaseAttackTime = 0;
} else {
    $BaseAttackTime = $_POST['BaseAttackTime'];
}
if (empty($_POST['RangeAttackTime'])) {
    $RangeAttackTime = 0;
} else {
    $RangeAttackTime = $_POST['RangeAttackTime'];
}
if (empty($_POST['unit_class'])) {
    $unit_class = 0;
} else {
...
if (empty($_POST['lootid'])) {
    $lootid = 0;
} else {
    $lootid = $_POST['lootid'];
}
if (empty($_POST['resistance1'])) {
    $resistance1 = 0;
} else {
    $resistance1 = $_POST['resistance1'];
}
if (empty($_POST['resistance2'])) {
    $resistance2 = 0;
} else {
    $resistance2 = $_POST['resistance2'];
}
if (empty($_POST['resistance3'])) {
    $resistance3 = 0;
} else {
    $resistance3 = $_POST['resistance3'];
}
if (empty($_POST['resistance4'])) {
    $resistance4 = 0;
} else {
    $resistance4 = $_POST['resistance4'];
}
if (empty($_POST['resistance5'])) {
    $resistance5 = 0;
} else {
    $resistance5 = $_POST['resistance5'];
}
if (empty($_POST['resistance6'])) {
    $resistance6 = 0;
} else {
    $resistance6 = $_POST['resistance6'];
}
if (empty($_POST['mingold'])) {
    $mingold = 0;
} else {
    $mingold = $_POST['mingold'];
}
if (empty($_POST['maxgold'])) {
    $maxgold = 0;
} else {
